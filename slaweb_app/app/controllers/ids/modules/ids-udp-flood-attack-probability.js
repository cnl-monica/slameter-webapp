...
var IdsUdpFloodAttackProbabilityController = IdsBaseModuleWithChartController.extend({

    name: 'IdsUdpFloodAttackProbability',
    ...
    addToArray: function() {
        ...
        if (adat3[2] === true){
            this.send('showMessage', 'Time: ' + time + ' - UDP flood attack detected with attack probability: ' + adat3[1] + '%', 'error');
    ...
    toolboxTemplate: 'ids/modules/ids-udp-flood-attack-probability--toolbox'



});

export default IdsUdpFloodAttackProbabilityController;
