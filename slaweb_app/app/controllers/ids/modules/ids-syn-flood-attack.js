...
var IdsSynFloodAttackController = IdsBaseModuleWithChartController.extend({

    name: 'IdsSynFloodAttack',
...
//        if (adat3[2] === true){
//            this.send('showMessage', 'SYN flood attack detected with count: ' + adat3[1] + '!', 'error');
//        }
    }.observes('adat'),
    ...
    toolboxTemplate: 'ids/modules/ids-syn-flood-attack--toolbox'

});

export default IdsSynFloodAttackController;
