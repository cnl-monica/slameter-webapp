...
var IdsTtlFloodAttackController = IdsBaseModuleWithChartController.extend({

    name: 'IdsTtlFloodAttack',
...
//        if (adat3[2] === true){
//            this.send('showMessage', 'TTL flood attack detected with count: ' + adat3[1] + '!', 'error');
//        }
    }.observes('adat'),
    ...
    toolboxTemplate: 'ids/modules/ids-ttl-flood-attack--toolbox'



});

export default IdsTtlFloodAttackController;
