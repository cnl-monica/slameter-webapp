...
var IdsFinFloodAttackController = IdsBaseModuleWithChartController.extend({

    name: 'IdsFinFloodAttack',
...
//        if (adat3[2] === true){
//            this.send('showMessage', 'FIN flood attack detected with count: ' + adat3[1] + '!', 'error');
//        }
    }.observes('adat'),
    ...
    toolboxTemplate: 'ids/modules/ids-fin-flood-attack--toolbox'



});

export default IdsFinFloodAttackController;
