...
var IdsFinFloodAttackProbabilityController = IdsBaseModuleWithChartController.extend({

    name: 'IdsFinFloodAttackProbability',
    ...
    addToArray: function() {
        ...
        if (adat3[2] === true){
            this.send('showMessage', 'Time: ' + time + ' - FIN flood attack detected with attack probability: ' + adat3[1] + '%', 'error');
    ...
    toolboxTemplate: 'ids/modules/ids-fin-flood-attack-probability--toolbox'



});

export default IdsFinFloodAttackProbabilityController;
