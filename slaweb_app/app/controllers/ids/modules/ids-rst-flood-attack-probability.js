...
var IdsRstFloodAttackProbabilityController = IdsBaseModuleWithChartController.extend({

    name: 'IdsRstFloodAttackProbability',
    ...
    addToArray: function() {
        ...
        if (adat3[2] === true){
            this.send('showMessage', 'Time: ' + time + ' - RST flood attack detected with attack probability: ' + adat3[1] + '%', 'error');
    ...
    toolboxTemplate: 'ids/modules/ids-rst-flood-attack-probability--toolbox'



});

export default IdsRstFloodAttackProbabilityController;
