...
var IdsPortScanAttackProbabilityController = IdsBaseModuleWithChartController.extend({

    name: 'IdsPortScanAttackProbability',
    ...
    callModule: "IdsPortScanNavigation",
    ...
    addToArray: function() {
        ...
        if (adat3[2] === true){
            this.send('showMessage', 'Time: ' + time + ' - Port scan attack detected with attack probability: ' + adat3[1] + '%', 'error');
    ...
    toolboxTemplate: 'ids/modules/ids-port-scan-attack-probability--toolbox'



});

export default IdsPortScanAttackProbabilityController;
