...
var IdsSynFloodAttackProbabilityController = IdsBaseModuleWithChartController.extend({

    name: 'IdsSynFloodAttackProbability',
    ...
    addToArray: function() {
        ...
        if (adat3[2] === true){
            this.send('showMessage', 'Time: ' + time + ' - SYN flood attack detected with attack probability: ' + adat3[1] + '%', 'error');
...
//        }
    ...
    toolboxTemplate: 'ids/modules/ids-syn-flood-attack-probability--toolbox'

});

export default IdsSynFloodAttackProbabilityController;
