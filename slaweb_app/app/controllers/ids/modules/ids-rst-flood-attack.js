...
var IdsRstFloodAttackController = IdsBaseModuleWithChartController.extend({

    name: 'IdsRstFloodAttack',
...
//        if (adat3[2] === true){
//            this.send('showMessage', 'RST flood attack detected with count: ' + adat3[1] + '!', 'error');
//        }
    }.observes('adat'),
    ...
    toolboxTemplate: 'ids/modules/ids-rst-flood-attack--toolbox'



});

export default IdsRstFloodAttackController;
