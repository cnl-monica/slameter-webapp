...
var IdsUdpFloodAttackController = IdsBaseModuleWithChartController.extend({

    name: 'IdsUdpFloodAttack',
...
//        if (adat3[2] === true){
//            this.send('showMessage', 'UDP flood attack detected with count: ' + adat3[1] + '!', 'error');
//        }
    }.observes('adat'),
    ...
    toolboxTemplate: 'ids/modules/ids-udp-flood-attack--toolbox'



});

export default IdsUdpFloodAttackController;
