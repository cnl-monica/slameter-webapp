...
var ThroughputInPacketsController = NetstatBaseModuleWithChartController.extend({
    chartDataLabel: 'ThroughputInP',
    name: 'throughputInP',
    ...
    toolboxTemplate: 'netstat/modules/throughput-in-packets--toolbox'



});

export default ThroughputInPacketsController;