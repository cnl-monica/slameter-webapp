...
var ThroughputInBytesController = NetstatBaseModuleWithChartController.extend({
    chartDataLabel: 'ThroughputInB',
    name: 'throughputInB',
    ...
    toolboxTemplate: 'netstat/modules/throughput-in-bytes--toolbox'



});

export default ThroughputInBytesController;