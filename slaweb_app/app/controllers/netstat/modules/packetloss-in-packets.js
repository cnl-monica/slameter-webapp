...
var PacketlossInPacketsController = NetstatBaseModuleWithChartController.extend({
    chartDataLabel: 'PacketlossInP',
    name: 'packetlossInP',
    ...
    toolboxTemplate: 'netstat/modules/packetloss-in-packets--toolbox'



});

export default PacketlossInPacketsController;