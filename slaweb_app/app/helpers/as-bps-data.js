...
import {bpsTo} from 'slameter/lib/data-units';

/**
 * This helper converts passed value with `bytesTo` utility,
 * from *bps* to other data unit. If no `unit` option is specified,
 ...
 * @return {String}
 */
var AsBpsDataHelper = Ember.Handlebars.makeBoundHelper(function(value, options) {
    options = options || {};
    ...
    if (!isNaN(parsedValue)) {
        output = bpsTo[unit](parsedValue, decimals);
    } else {
        output = value;
    }
...
export default AsBpsDataHelper;
